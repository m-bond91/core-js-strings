...
removeLeadingAndTrailingWhitespaces(' gff ');
...
removeFirstOccurrences('Hi user, How are you?', 'user');
...
removeLastOccurrences('Hi user, How are you user?', 'user');
...
countVowels('Returns the number of vowels in the string');
...
findLongestWord(
  'Find the longest word in the sentence. If there are multiple longest words, the function returns the first one encountered.'
);
...
reverseWords('Returns the string where each word is reversed.');
...
invertCase('Inverts the case of each character in the given string.');
...
getStringFromTemplate('Rita', 'Bond');
